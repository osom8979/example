...
class MyFrameT31: public wxDialog
{
public:
    MyFrameT31(const wxString& title);
};

MyFrameT31::MyFrameT31(const wxString & title) :
        wxDialog(NULL, -1, title, wxDefaultPosition, wxSize(250, 230))
{
    ...
    wxRadioButton *rb = new wxRadioButton(panel, -1, wxT("256 Colors"), wxPoint(15, 30),
...
int t31()
{
    MyFrameT31 * frame = new MyFrameT31(wxT("MyFrame"));
    frame->Show(true);
    return EXIT_SUCCESS;
}
