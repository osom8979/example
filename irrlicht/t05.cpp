 ...
 */
void _t05_setSkinTransparency(s32 alpha, irr::gui::IGUISkin * skin)
{
        ...
        if (event.EventType == EET_GUI_EVENT) {
            ...
            case EGET_SCROLL_BAR_CHANGED:
                if (id == GUI_ID_TRANSPARENCY_SCROLL_BAR) {
                    ...
                    _t05_setSkinTransparency(pos, env->getSkin());
                }
                break;
                ...
                case GUI_ID_NEW_WINDOW_BUTTON: {
                    ...
                    IGUIWindow* window = env->addWindow(
                            rect<s32>(100 + Context.counter, 100 + Context.counter,
                                    300 + Context.counter, 200 + Context.counter), false, // modal?
                            L"Test window");

                    env->addStaticText(L"Please close me", rect<s32>(35, 35, 140, 50), true, // border?
                            false, // wordwrap?
                            window);
                }
                    return true;
...
int t05()
{
    ...
    env->addButton(rect<s32>(10, 240, 110, 240 + 32), 0, GUI_ID_QUIT_BUTTON, L"Quit",
            L"Exits Program");
    env->addButton(rect<s32>(10, 280, 110, 280 + 32), 0, GUI_ID_NEW_WINDOW_BUTTON, L"New Window",
            L"Launches a new Window");
    env->addButton(rect<s32>(10, 320, 110, 320 + 32), 0, GUI_ID_FILE_OPEN_BUTTON, L"File Open",
            L"Opens a file");
    ...
    IGUIScrollBar* scrollbar = env->addScrollBar(true, rect<s32>(150, 45, 350, 60), 0,
            GUI_ID_TRANSPARENCY_SCROLL_BAR);
    scrollbar->setMax(255);
    scrollbar->setPos(255);
    _t05_setSkinTransparency(scrollbar->getPos(), env->getSkin());
