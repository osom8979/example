...
public:
    virtual bool OnEvent(const SEvent& event)
    {
        ...
        if (event.EventType == irr::EET_KEY_INPUT_EVENT && event.KeyInput.Key == KEY_KEY_S
...
int t18()
{
    ...
    IrrlichtDevice *device = createDevice(driverType, dimension2du(ResX, ResY), 32, fullScreen,
