    ...
    while (device->run() && driver) {
        if (device->isWindowActive()) {
            ...
            driver->draw2DImage(images, core::position2d<s32>(50, 50),
                    core::rect<s32>(0, 0, 342, 224), 0, video::SColor(255, 255, 255, 255), true);
            ...
            driver->draw2DImage(images, core::position2d<s32>(270, 105),
                    (time / 500 % 2) ? imp1 : imp2, 0, video::SColor(255, (time) % 255, 255, 255),
                    true);
            ...
            if (font2) font2->draw(L"Also mixing with 3d graphics is possible.",
