...
set (_library_name       "glog")
set (_library_dir_name   "${_library_name}-0.3.4")
set (_library_url        "https://codeload.github.com/google/glog/tar.gz/v0.3.4")
set (_library_md5        "df92e05c9d02504fb96674bc776a41cb")
set (_library_dest_name  "${_library_dir_name}.tar.gz")
set (_library_work_name  "${_library_dir_name}")

set (_install_file_name  "${CMAKE_STATIC_LIBRARY_PREFIX}glog${CMAKE_STATIC_LIBRARY_SUFFIX}")
