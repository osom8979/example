...
set (_library_name       "libuv")
set (_library_dir_name   "${_library_name}-1.8.0")
set (_library_url        "https://codeload.github.com/libuv/libuv/tar.gz/v1.8.0")
set (_library_md5        "03c6a70f6ce8cf2d7ccf1f851e21599e")
set (_library_dest_name  "${_library_dir_name}.tar.gz")
set (_library_work_name  "${_library_dir_name}")

set (_install_file_name  "${CMAKE_STATIC_LIBRARY_PREFIX}uv${CMAKE_STATIC_LIBRARY_SUFFIX}")
