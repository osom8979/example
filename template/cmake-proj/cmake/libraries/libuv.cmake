## CMake libuv build script.

if (VERBOSE)
    message (">> Library name: libuv")
...
set (_proj_name     "libuv-1.8.0")
set (_proj_url      "https://codeload.github.com/libuv/libuv/tar.gz/v1.8.0")
...
# exists library.
set (_static_lib_name  "${CMAKE_STATIC_LIBRARY_PREFIX}uv${CMAKE_STATIC_LIBRARY_SUFFIX}")
