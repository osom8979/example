...
set (_proj_name     "libpng-1.6.20")
set (_proj_url      "http://netix.dl.sourceforge.net/project/libpng/libpng16/1.6.20/libpng-1.6.20.tar.gz")
...
# exists library.
set (_static_lib_name  "${CMAKE_STATIC_LIBRARY_PREFIX}png${CMAKE_STATIC_LIBRARY_SUFFIX}")
...
execute_process (
    COMMAND ./configure "--prefix=${_prefix}" --disable-shared --enable-static
