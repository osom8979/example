...
set (_library_name       "libpng")
set (_library_dir_name   "${_library_name}-1.6.20")
set (_library_url        "http://netix.dl.sourceforge.net/project/libpng/libpng16/1.6.20/libpng-1.6.20.tar.gz")
set (_library_md5        "53166795d924950988a5513d3e605333")
set (_library_dest_name  "${_library_dir_name}.tar.gz")
set (_library_work_name  "${_library_dir_name}")

set (_install_file_name  "${CMAKE_STATIC_LIBRARY_PREFIX}png${CMAKE_STATIC_LIBRARY_SUFFIX}")
set (_library_already    "${_library_prefix}/lib/${_install_file_name}")

set (_library_update)
set (_library_autoconfig)
set (_library_configure   ./configure "--prefix=${_library_prefix}" --disable-shared --enable-static)
