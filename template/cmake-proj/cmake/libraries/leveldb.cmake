...
set (_library_name       "leveldb")
set (_library_dir_name   "${_library_name}-1.18")
set (_library_url        "https://codeload.github.com/google/leveldb/tar.gz/v1.18")
set (_library_md5        "73770de34a2a5ab34498d2e05b2b7fa0")
...
set (_library_install  ${CMAKE_COMMAND} "-D_build_dir=${_library_temp_dir}/${_library_work_name}"
                                        ...
                                        -P "${PROJECT_SOURCE_DIR}/cmake/libraries/leveldb-install.cmake")
set (_library_test)
