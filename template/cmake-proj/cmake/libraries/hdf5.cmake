set (_proj_name     "hdf5-1.8.16")
set (_proj_url      "https://www.hdfgroup.org/ftp/HDF5/current/src/hdf5-1.8.16.tar.gz")
...
set (_library_name       "hdf5")
set (_library_dir_name   "${_library_name}-1.8.16")
set (_library_url        "https://www.hdfgroup.org/ftp/HDF5/current/src/hdf5-1.8.16.tar.gz")
set (_library_md5        "b8ed9a36ae142317f88b0c7ef4b9c618")
set (_library_dest_name  "${_library_dir_name}.tar.gz")
set (_library_work_name  "${_library_dir_name}")

set (_install_file_name  "${CMAKE_STATIC_LIBRARY_PREFIX}hdf5${CMAKE_STATIC_LIBRARY_SUFFIX}")
